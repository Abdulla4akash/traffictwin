...
MODEL_TYPES: dict[str, type[BaseModel]] = {
    ...
    "ManchesterAggregateRetentionPolicy": ManchesterAggregateRetentionPolicy,
    "ManchesterOperationalAttemptRecord": ManchesterOperationalAttemptRecord,
    "ManchesterOperationalJournalReport": ManchesterOperationalJournalReport,
    "ManchesterOperationalAppendReceipt": ManchesterOperationalAppendReceipt,
    "ManchesterOperationalCadenceExpectation": ManchesterOperationalCadenceExpectation,
    "ManchesterOperationalSourceDayAggregate": ManchesterOperationalSourceDayAggregate,
    "ManchesterOperationalDayAggregate": ManchesterOperationalDayAggregate,
    "ManchesterLondonHourAggregate": ManchesterLondonHourAggregate,
    "ManchesterOperationalDayPublicationReceipt": ManchesterOperationalDayPublicationReceipt,
    "NationalHighwaysAcceptedTransitionSnapshot": NationalHighwaysAcceptedTransitionSnapshot,
    "NationalHighwaysTransitionHistory": NationalHighwaysTransitionHistory,
    "NationalHighwaysRecordTransition": NationalHighwaysRecordTransition,
    "NationalHighwaysTransitionCounts": NationalHighwaysTransitionCounts,
    "NationalHighwaysTransitionReport": NationalHighwaysTransitionReport,
    "NationalHighwaysPublicTransitionAggregate": NationalHighwaysPublicTransitionAggregate,
    "BodsSourceAgeDistribution": BodsSourceAgeDistribution,
    ...
    "RestrictedTrafficFeedAccessContract": RestrictedTrafficFeedAccessContract,
    "ProviderContractAssessment": ProviderContractAssessment,
    ...
    "BeeNetworkMembershipReport": BeeNetworkMembershipReport,
    ...
    "BodsLiveControlPolicy": BodsLiveControlPolicy,
    "BodsLiveControlState": BodsLiveControlState,
    "BodsRetentionPolicy": BodsRetentionPolicy,
    ...
    "NationalHighwaysEnvelope": NationalHighwaysEnvelope,
    "NationalHighwaysRecord": NationalHighwaysRecord,
    "NationalHighwaysParseCounts": NationalHighwaysParseCounts,
    "NationalHighwaysParseReport": NationalHighwaysParseReport,
    "NationalHighwaysAcquisitionRequest": NationalHighwaysAcquisitionRequest,
    "NationalHighwaysAcquisitionResult": NationalHighwaysAcquisitionResult,
    "NationalHighwaysProductSummary": NationalHighwaysProductSummary,
    "NationalHighwaysRefreshSummary": NationalHighwaysRefreshSummary,
    "NationalHighwaysControlState": NationalHighwaysControlState,
...
CLI_COMMANDS = [
    ...
    ["release", "v07-operational-history-status"],
    ["release", "v07-operational-day-preview"],
    ["experiment"],
    ...
    ["integration", "manchester", "network", "verify-decode"],
    ["integration", "manchester", "network", "status"],
    ["integration", "manchester", "network", "connectivity"],
    ["integration", "manchester", "workflow"],
    ["integration", "manchester", "workflow", "status"],
    ["integration", "manchester", "workflow", "decisions"],
    ["integration", "manchester", "observation"],
    ["integration", "manchester", "observation", "snapshots"],
    ["integration", "manchester", "match"],
    ["integration", "manchester", "match", "policy"],
    ["integration", "manchester", "match", "ambiguity"],
    ["integration", "manchester", "match", "candidates"],
    ["integration", "manchester", "match", "review"],
    ["integration", "manchester", "observation", "acquire"],
    ["integration", "manchester", "run"],
    ["integration", "manchester", "run", "preflight"],
    ["integration", "manchester", "provider"],
    ["integration", "manchester", "provider", "template"],
    ["integration", "manchester", "provider", "status"],
    ["integration", "manchester", "demand"],
    ["integration", "manchester", "demand", "build"],
    ["integration", "manchester", "evidence"],
    ["integration", "manchester", "evidence", "lineage"],
    ["integration", "manchester", "evidence", "export"],
    ["integration", "manchester", "profile"],
    ["integration", "manchester", "profile", "policy"],
    ["integration", "manchester", "profile", "build"],
    ["integration", "manchester", "profile", "inspect"],
]
