...
4. Refuses any trace outside the pinned reviewed set (`UNREVIEWED_TRACE_REFUSED`); admitting
   another audited trace requires a validated VEC-06 receipt and a reviewed policy extension.
