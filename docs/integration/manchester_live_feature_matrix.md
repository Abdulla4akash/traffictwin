...
| Public live-data hosting/export | **Unavailable** | BODS terms, identifier retention/publication basis, National Highways release review, reference-data licences, and complete gate acceptance remain open |
...
near-live. Remaining Bee identifiers/licences, source-wide retention/publication decisions, and
formal capability/UI acceptance remain open. `MAN-01`, `MAN-03`, `MAN-05`, `MAN-07`, and `MAN-08`
therefore remain `planned`, while the bounded operational slice is honestly recorded as built.
