...
- **Provenance/standing:** heads/manifests/actor/trace as pinned; provenance in `E2ResearchExportBundle`; `docs/closure/e2_product_traceability.json` maps each lane to module; `docs/e2_research_product.md` is the concise user guide.
