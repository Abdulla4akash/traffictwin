...
canonical design specification at [docs/traffictwin-design-v0_5.md](traffictwin-design-v0_5.md).
It does not assume a runnable Randy/VEC environment, Randy-provided SUMO XML, Manchester sensors,
