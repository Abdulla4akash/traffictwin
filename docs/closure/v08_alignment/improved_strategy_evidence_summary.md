...
- **E2c execution imbalance:** Over 4 matched draws (fleet seeds 1–4), `ingress_dla` execution-share range 0.061–0.073 and `dla` (common-target) execution-share range 0.237–0.242 (max deviation concentrated on congested-road RSUs). Exact per-draw execution shares — ingress 0.061085, 0.072754, 0.070738, 0.067369; DLA 0.242396, 0.238025, 0.238580, 0.236705. `ingress_dla` forwarded 0; `dla` forwarded 234k–242k per draw [RESEARCH-EVIDENCE FACT — E2c mechanism summary `5556f0fc...`, manifest `fcaf2ee34b68ca4e4ef2e088d72ce2c5a410cf66ff9934a451fd8047204c480a`].
