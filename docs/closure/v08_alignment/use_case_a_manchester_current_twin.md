...
| 5 | Scenario Builder (author bounded synthetic incident) | `src/traffictwin/ui/pages/scenario_builder.py` | `/Scenario_Builder` | `src/traffictwin/ui/services/scenario.py` (via `src/traffictwin/ui/services/__init__.py`), `src/traffictwin/experiments/scenario_mutation.py` |
