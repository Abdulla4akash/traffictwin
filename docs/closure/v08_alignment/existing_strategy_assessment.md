...
| **Admission** | Cap 6220 same; gate rejected 2071344 seed0 (replaces ~834k caps); cap 0 at seed0 under ingress_dla. Caveat: `ingress_dla - off` retains step-entry vs live-backlog timing difference (138 unavailable in off, ~1e-5 per offered); not perfectly gate-only. | IMPLEMENTATION-VERIFIED FACT + RESEARCH-EVIDENCE FACT + INFERENCE caveat |
...
| **Benefit** | Admission benefit under strongest-link: seed0 ingress_dla 0.715773211 vs off 0.683619229 (+0.032153983) admitted 0.897826701; E2c seeds1-4 ingress_dla 0.720032771, 0.703688004, 0.702976484, 0.708874512 consistently above paired dla. Fewer admitted (-1237224 seed0 vs off; 10424749 - 11661973) but higher conditional success; latency down. | RESEARCH-EVIDENCE FACT (1+4 draws, not independent replicates) |
| **Failure mode** | Conservative backlog-only gate may reject some tasks that could have drained in time; ~2.07M rejections (2071344) seed0. Trace/cap/service dependent. | INFERENCE limited to tested condition |
| **Cost** | Fixed 1x, no backhaul, fewer admitted throughput, energy ~0.468 J. | RESEARCH-EVIDENCE FACT |
| **Experiment evidence** | E2b manifest `9383ec767dccf2f390b498e0c20283a74cd64fa521d6137fe23ce38d0022af91` comparison `8d35e55e2952d71b1c04479b310d1f5b48da7cf7bc2e171a1ca6359c9fa98aaf` validation `e45ee4016887596476032b441762c38a92e0faed83738c30fbf590385243d8c1` report `c9f3cc9d84cfc27db1386c14148b9166dd56d5c2c3726d1e6e8f6057018f7a83` head `fe2ed4e9bd9043b19b96a5f179390db629b01ccb` raw `a0198c9f38295db8ee0aa34b2b4c786ebcb5c034450cb59b616f4a11076ea5c6`; E2c multidraw manifest `fcaf2ee34b68ca4e4ef2e088d72ce2c5a410cf66ff9934a451fd8047204c480a` comparison `b0bc17ef097e8a8ca3639482bbf5ae05ef249c1221836cc6591207e87b511970` validation `25b80d66d991b424e20a7fd18d9e45c641cddc4b4aa9ffeed0cbdccacb5f8f2f` raw `d3f41d2fc21257f16518f62ec2fbbde55243a89d31726c57f1a0171fe7f582d4` heads `e2b fe2ed...` / `e2c 1a08d6e148a1e8c430da39c3d575eda3f8ea5929` vec_env `0e5ed2f79b50011fe0475a5c2069978f9fdd778d` observed 0.715773211 admitted 0.897826701 offered 13076234 admitted 10424749 V2I 580907 gate 2071344 contrast +0.03215 vs off, E2c 1-4 as above. | RESEARCH-EVIDENCE FACT |
...
| **Benefit** | Admission benefit under JSQ: dla vs jsq +0.019258144 offered (seed0), +0.169979 admitted, latency -15400 ms, 2018315 fewer admitted tasks (10122571 dla vs 12140886 jsq) but higher conditional success; this is admission, not placement. | RESEARCH-EVIDENCE FACT |
...
| **Cost** | Fixed 1x; backhaul zero but high forward count concentrates work; admitted 2018315 fewer than jsq (10122571 vs 12140886) and fewer than ingress_dla; gate cost consistent with benefit. | RESEARCH-EVIDENCE FACT |
...
| **Forwarding** | When selected ≠ ingress and admitted: E2d seeds1-4 forwarded ~600885,600181,601402,600755 share ~0.899-0.900 of 667k V2I admitted, higher than dla ~234k, zero latency; matrix more off-diagonal. Execution near-uniform across all ten RSUs (counts roughly 66.3k–67.3k per RSU; execution-share ranges 0.000744/0.000824/0.000706/0.001387; mean difference versus dla about -0.2380, versus ingress about -0.0671). | RESEARCH-EVIDENCE FACT |
...
| **Failure mode** | Per-task O(KMAX·N) placement evaluations per timestep vs one per substep; forwarding roughly 600k tasks (share 0.899–0.900 of 667k admitted V2I, ~2.5× vs common-target dla ~234–241k) increases backhaul exposure under nonzero cost. Execution is near-uniform across all ten RSUs (counts roughly 66.3k–67.3k per RSU; execution-share ranges 0.000744/0.000824/0.000706/0.001387; mean difference versus dla about -0.2380, versus ingress about -0.0671), not concentrated to a subset. No stale-state or backhaul test; staleness would affect per-task more (more decisions on stale state). | INFERENCE + IMPLEMENTATION-VERIFIED FACT |
