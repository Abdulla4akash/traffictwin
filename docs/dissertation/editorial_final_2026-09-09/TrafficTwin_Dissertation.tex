...
\caption{Experimental responsibility boundaries. Only admitted V2I work enters the selected execution queue; logical forwarding applies when ingress and execution differ. Resource scaling is outside the completed comparison \hyperref[source-s11]{[S11]}.}\label{fig:1}
\end{figure}
...
% BEGIN SOURCE BLOCK 084 heading
...
% BEGIN SOURCE BLOCK 103 heading
...
% BEGIN SOURCE BLOCK 125 heading
...
% BEGIN SOURCE BLOCK 132 proposition
...
% BEGIN SOURCE BLOCK 168 bibliography_open
...
% BEGIN SOURCE BLOCK 183 bibliography_close
\end{thebibliography}
% END SOURCE BLOCK 183

% BEGIN SOURCE BLOCK 184 appendix_open
\appendix
...
% BEGIN SOURCE BLOCK 223 heading
...
% BEGIN SOURCE BLOCK 227 paragraph
...
% BEGIN SOURCE BLOCK 231 heading
...
% BEGIN SOURCE BLOCK 234 heading
...
% BEGIN SOURCE BLOCK 237 equation
...
% BEGIN SOURCE BLOCK 241 proof_open
\begin{proof}
...
% BEGIN SOURCE BLOCK 244 proof_close
\end{proof}
...
% BEGIN SOURCE BLOCK 247 proof_open
\begin{proof}
...
% BEGIN SOURCE BLOCK 250 proof_close
\end{proof}
...
% BEGIN SOURCE BLOCK 254 heading
...
% BEGIN SOURCE BLOCK 257 heading
...
% BEGIN SOURCE BLOCK 267 heading
...
% BEGIN SOURCE BLOCK 272 heading
