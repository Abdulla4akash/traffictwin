...
FROZEN=ROOT/'docs/evaluation/vec_followup_2026-09-07/frozen_evaluator'
spec=importlib.util.spec_from_file_location('extension_frozen_causal',FROZEN/'eval/e2d_per_task_placement.py')
