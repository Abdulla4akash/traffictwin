...
def main():
    ...
    ap.add_argument("--rsu-lb", default="off",
                    choices=["off", "jsq", "p2c", "dla", "dla_p2c",
                             "ingress_dla", "per_task_dla", "causal_round_robin"],
    ...
    def step(carry, xs):
        ...
        def sub_step(c, sub_idx):
            ...
            if args.rsu_lb != "off":
                ...
                if args.rsu_lb not in ("per_task_dla", "causal_round_robin"):
                    rsu_ok = (v2i_q > 0.0) & (
                        rl[exec_idx] < V.RSU_MAX_CONCURRENT)
                    rsu_ok_pre = rsu_ok
                if SEQQ and args.rsu_lb not in ("per_task_dla", "causal_round_robin"):
        ...
        if PERTASK:
            ys.update(task_sizes_mb=sub_ys[-2], task_rsu_service_ms=sub_ys[-1])
    ...
    out["extension_schema"] = "joint_seed_cyclic_v1"
