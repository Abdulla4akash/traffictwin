...
def url_for(href):
    ...
    if p.is_relative_to(REPO):
        ...
        revision = '1b6a8555c27901ec95ad8b123c413453ecdb5620' if '/gap_closure_2026-09-08/' in relative else BASELINE
    ...
    while i < len(tokens):
        ...
        if tok.type == 'table_open':
            ...
            proportions = {
                ...
                7: [.09,.19,.19,.16,.20,.17],
                8: [.115,.12,.10,.175,.16,.175,.155],
                9: [.14,.20,.26,.20,.20], 10: [.26,.29,.45],
                11: [.20,.31,.25,.24], 12: [.11,.18,.18,.18,.18,.17],
            }[table_number]
