...
\clearpage
\tableofcontents
\vfill\noindent\textbf{Word count: 8,984} (main text including tables, equations
and pseudocode; excluding captions, references, appendices and front matter);
7,784 excluding tables and pseudocode.\par
\clearpage
{\small\singlespacing
\listoffigures
\listoftables
...
\textbf{C5.} Designing and executing the comparison of six infrastructure policies over three replication stages and more than eighty full evaluator runs, with offered-task accounting and prespecified simultaneous intervals (Sections 2.6 and 3.2--3.4).
...
One archived MAPPO checkpoint and one device-tier preset are fixed throughout; training was not reproduced (Appendix~\ref{app:F}).
...
Table~\ref{tab:3a} makes the design trade-offs explicit, using the controls and limitations already described. The alternatives provide a retrospective comparison of methodological choices; they were not all evaluated. Matched conditions support attribution within the evaluator, while replication defines which uncertainty the intervals address.
...
Causal round-robin control & Random or two-choice (\path{dla_p2c}) spreading & Isolates workload awareness with identical admission kernel; Section~\ref{sec:3.2} explains comparator development & Two-choice comparison deferred (Section~\ref{sec:4.4}) \\
...
\FloatBarrier
% BEGIN SOURCE BLOCK 123 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 131 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 141 heading
...
\FloatBarrier
\clearpage
% BEGIN SOURCE BLOCK 151 heading
...
% BEGIN SOURCE BLOCK 154 proposition
...
\FloatBarrier
% BEGIN SOURCE BLOCK 164 heading
...
\FloatBarrier
\clearpage
% BEGIN SOURCE BLOCK 179 heading
...
\textbf{Complexity and scope.} I coordinated an investigation across two Manchester scenarios, one frozen actor and three replication stages: incident draws, prospective morning replication and joint-randomness confirmation. Table~\ref{tab:A1} in Appendix~\ref{app:A} lists component sizes and recorded checks.
% END SOURCE BLOCK 185

% BEGIN SOURCE BLOCK 186 paragraph
...
\FloatBarrier
% BEGIN SOURCE BLOCK 188 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 193 heading
...
% BEGIN SOURCE BLOCK 196 paragraph
...
\FloatBarrier
% BEGIN SOURCE BLOCK 198 heading
...
% BEGIN SOURCE BLOCK 203 bibliography_open
...
% BEGIN SOURCE BLOCK 250 bibliography_close
\end{thebibliography}
% END SOURCE BLOCK 250

% BEGIN SOURCE BLOCK 251 appendix_open
\appendix
\setlength{\parskip}{0.3em}
\renewcommand{\thetable}{\Alph{section}\arabic{table}}
% END SOURCE BLOCK 251

% BEGIN SOURCE BLOCK 252 heading
...
% BEGIN SOURCE BLOCK 295 paragraph
...
% BEGIN SOURCE BLOCK 300 paragraph
...
% BEGIN SOURCE BLOCK 305 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 307 heading
...
% BEGIN SOURCE BLOCK 310 equation
...
% BEGIN SOURCE BLOCK 316 paragraph
...
% BEGIN SOURCE BLOCK 317 proof_close
\end{proof}
...
% BEGIN SOURCE BLOCK 320 proof_open
\begin{proof}
...
% BEGIN SOURCE BLOCK 323 proof_close
\end{proof}
...
\FloatBarrier
% BEGIN SOURCE BLOCK 330 heading
...
% BEGIN SOURCE BLOCK 338 paragraph
...
% BEGIN SOURCE BLOCK 344 paragraph
...
\FloatBarrier
% BEGIN SOURCE BLOCK 345 heading
...
% BEGIN SOURCE BLOCK 351 paragraph
...
% BEGIN SOURCE BLOCK 353 paragraph
...
% BEGIN SOURCE BLOCK 356 paragraph
...
% BEGIN SOURCE BLOCK 358 paragraph
...
% BEGIN SOURCE BLOCK 363 heading
...
% BEGIN SOURCE BLOCK 372 paragraph
...
% BEGIN SOURCE BLOCK 374 paragraph
...
% BEGIN SOURCE BLOCK 380 paragraph
...
% BEGIN SOURCE BLOCK 381 paragraph
...
% BEGIN SOURCE BLOCK 383 heading
...
% BEGIN SOURCE BLOCK 388 paragraph
...
% BEGIN SOURCE BLOCK 389 paragraph
