...
\clearpage
\tableofcontents
\vfill\noindent\textbf{Word count: 8,914} (main text including tables, equations
and pseudocode; excluding captions, references, appendices and front matter);
7,714 excluding tables and pseudocode.\par
\clearpage
{\small\singlespacing
\listoffigures
\listoftables
...
Communication and computation jointly determine whether an offloaded task returns in time \cite{ref3}, \cite{ref6}.
...
\FloatBarrier
% BEGIN SOURCE BLOCK 023 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 050 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 057 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 064 heading
...
% BEGIN SOURCE BLOCK 067 equation
...
% BEGIN SOURCE BLOCK 068 equation
...
% BEGIN SOURCE BLOCK 073 paragraph
...
% BEGIN SOURCE BLOCK 075 equation
...
% BEGIN SOURCE BLOCK 079 equation
...
\FloatBarrier
% BEGIN SOURCE BLOCK 081 heading
...
% BEGIN SOURCE BLOCK 088 algorithm
\begin{algorithm}[htbp]
...
\FloatBarrier
% BEGIN SOURCE BLOCK 092 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 110 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 126 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 136 heading
...
\FloatBarrier
\clearpage
% BEGIN SOURCE BLOCK 146 heading
...
% BEGIN SOURCE BLOCK 149 proposition
...
\FloatBarrier
\clearpage
% BEGIN SOURCE BLOCK 153 heading
...
\FloatBarrier
\clearpage
% BEGIN SOURCE BLOCK 174 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 176 heading
...
% BEGIN SOURCE BLOCK 198 bibliography_open
