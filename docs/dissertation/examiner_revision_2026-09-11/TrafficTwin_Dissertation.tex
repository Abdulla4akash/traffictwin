...
\clearpage
\tableofcontents
\vfill\noindent\textbf{Word count: 9,576} (main text including tables, equations
and pseudocode; excluding captions, references, appendices and front matter);
7,880 excluding tables and pseudocode.\par
\clearpage
