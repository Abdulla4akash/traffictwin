...
\clearpage
\tableofcontents
\vfill\noindent\textbf{Word count: 8,960} (main text including tables, equations
and pseudocode; excluding captions, references, appendices and front matter);
7,760 excluding tables and pseudocode.\par
\clearpage
{\small\singlespacing
\listoffigures
\listoftables
