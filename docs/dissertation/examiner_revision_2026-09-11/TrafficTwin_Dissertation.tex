...
\usepackage[hidelinks,unicode,pdftitle={Dynamic Resource Management for Intelligent Transport Systems},pdfauthor={S M Abdulla Al Mamun}]{hyperref}
...
\begin{center}
\vspace*{12mm}
\parbox{0.72\textwidth}{\centering\Large\bfseries Dynamic Resource Management for Intelligent Transport Systems\par}\par
\vspace{18mm}
...
\clearpage
\tableofcontents
\vfill\noindent\textbf{Word count: 9,358} (main text including tables, equations
and pseudocode; excluding captions, references, appendices and front matter);
7,804 excluding tables and pseudocode.\par
\clearpage
...
\textbf{O1 --- Establish the measurement contract.} Distinguish offers, admissions, failures and deadline success. Treat accounting validation (E0) and capacity scoping (E1) as validation and scoping, retaining historical evidence limits.
