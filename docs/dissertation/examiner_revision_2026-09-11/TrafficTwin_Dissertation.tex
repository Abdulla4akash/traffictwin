...
\clearpage
\tableofcontents
\vfill\noindent\textbf{Word count: 8,938} (main text including tables, equations
and pseudocode; excluding captions, references, appendices and front matter);
7,738 excluding tables and pseudocode.\par
\clearpage
{\small\singlespacing
\listoffigures
\listoftables
...
\FloatBarrier
% BEGIN SOURCE BLOCK 041 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 045 heading
\section{Methodology}\label{sec:2}
% END SOURCE BLOCK 045

\FloatBarrier
% BEGIN SOURCE BLOCK 046 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 049 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 100 heading
...
\FloatBarrier
\clearpage
% BEGIN SOURCE BLOCK 104 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 108 heading
...
% BEGIN SOURCE BLOCK 114 paragraph
...
\FloatBarrier
% BEGIN SOURCE BLOCK 116 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 134 heading
...
% BEGIN SOURCE BLOCK 147 proposition
...
\FloatBarrier
% BEGIN SOURCE BLOCK 157 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 181 heading
...
% BEGIN SOURCE BLOCK 196 bibliography_open
...
% BEGIN SOURCE BLOCK 243 bibliography_close
\end{thebibliography}
% END SOURCE BLOCK 243

% BEGIN SOURCE BLOCK 244 appendix_open
\appendix
\setlength{\parskip}{0.3em}
\renewcommand{\thetable}{\Alph{section}\arabic{table}}
% END SOURCE BLOCK 244

% BEGIN SOURCE BLOCK 245 heading
...
% BEGIN SOURCE BLOCK 265 anchor
\phantomsection\label{source-s9}
% END SOURCE BLOCK 265

% BEGIN SOURCE BLOCK 266 paragraph
...
% BEGIN SOURCE BLOCK 285 heading
...
% BEGIN SOURCE BLOCK 303 equation
...
% BEGIN SOURCE BLOCK 310 proof_close
\end{proof}
% END SOURCE BLOCK 310

\FloatBarrier
% BEGIN SOURCE BLOCK 311 heading
...
% BEGIN SOURCE BLOCK 313 proof_open
\begin{proof}
...
% BEGIN SOURCE BLOCK 316 proof_close
\end{proof}
...
% BEGIN SOURCE BLOCK 318 paragraph
...
\FloatBarrier
% BEGIN SOURCE BLOCK 323 heading
...
\FloatBarrier
% BEGIN SOURCE BLOCK 326 heading
...
Scheduler timing uses actual JAX helpers, including three-replacement prefixes; precomputed candidate work replaces only the service provider. Sixteen configurations combine four arms, $N/R=215/9$ or 2,488/10, $K=5$ and sparse/empty or busy/nonempty fixtures. Arms share arrays with coupled type/deadline/service values. Busy entry queues are imposed stress states, excluded by exact clearing from empty initialisation (\S\,\ref{sec:3.5}). Following JAX guidance, compilation is separate, inputs are device-resident, five warm-ups precede 100 synchronised calls. Actor, radio, service generation, transfer, scoring and I/O are excluded. Repetitions measure host variability, not fleet uncertainty \cite{ref35}.
...
% BEGIN SOURCE BLOCK 376 heading
...
% BEGIN SOURCE BLOCK 378 paragraph
