...
| Need reproducibility and provenance. | Registry, fingerprints, versions, source row/file provenance. | `storage/`, `ingestion/hashes.py`, canonical records | registry tests, bundle tests | [reproducibility](reproducibility.md) | implemented |
