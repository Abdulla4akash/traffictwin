...
verified. Both GPU arms returned; the corridor remains preliminary/non-admitted, while Sparse-64
is locally integrity-verified but execution-deviated/non-admitted because its fixed peak
evaluation was repeated after first return. No browser extension or open browser tab is
required, the supervisor service is stopped, and no Colab session remains active.
