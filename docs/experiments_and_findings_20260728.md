...
| 21 | **B-BUS Sparse-64 dawn→peak** (owner approved; whole fleet, outside VEC-06) | **Two GPU sessions lost; no scientific result.** The one dawn-weighted 64-site array still covers **45.01% dawn / 46.00% peak** vehicle-seconds. First attempt: five concurrent jobs completed only 350–354/1,562 updates before termination at 02:53 UTC (03:53 BST). Observed throughput projects **8.49–8.59 h (mean 8.53 h)** plus setup/evaluation; a clean retry was lost after about 6.5 h with no durable actor/archive. Checkpoint/resume or a durable GPU is required. [Detailed settings and execution status](evaluation/bbus_dawn_peak_settings_and_preliminary_results_20260729.md) |
