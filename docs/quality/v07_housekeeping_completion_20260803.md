...
| Test, lint, typing, CI and fixtures | Existing gates were present; link and wheel-install coverage were missing | Extended CI while retaining locked dependencies, Ruff, strict mypy, full coverage suite, standalone demo, fixture immutability, generated references, package build and Python 3.12 container build |
