...
| REL-01 | v0.6/v0.7 isolation | INA | Workspace isolation, copy, ADR-058 attestation, attested activation/backup/rollback, coexistence check all tested; version alignment + final reconciliation open |
