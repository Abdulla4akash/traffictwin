...
_LIMITATIONS = [
    ...
    "Withdrawing a candidate does not deactivate an already-active baseline. An active withdrawn candidate remains active until another valid candidate supersedes it; there is no separate deactivate, retire, or revoke operation.",  # noqa: E501
]
