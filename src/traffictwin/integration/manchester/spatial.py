...
GeographicScope: TypeAlias = Literal[
    ...
    "national_highways_manchester_envelope",
    "declared_network",
    "synthetic",
    "unavailable",
]
ScopeBasis: TypeAlias = Literal[
    ...
    "bods_request_bounds",
    "national_highways_request_envelope",
...
GeometryMeaning: TypeAlias = Literal[
    ...
    "road_closure_position",
    "temporary_speed_restriction_position",
    "variable_message_sign_position",
    "simulation_position",
    "analysis_site",
    "synthetic_point",
    "unavailable",
...
def source_spatial_policy(source: SpatialSource) -> SpatialAdmissionPolicy:
    ...
    if source.startswith("national_highways_"):
        geometry: dict[SpatialSource, GeometryMeaning] = {
            "national_highways_closures": "road_closure_position",
            "national_highways_speed_limits": "temporary_speed_restriction_position",
            "national_highways_vms": "variable_message_sign_position",
        ...
        return SpatialAdmissionPolicy(
            ...
            source_crs=("EPSG:4326",),
            accepted_coordinate_kinds=("wgs84",),
            required_scope="national_highways_manchester_envelope",
            required_scope_basis="national_highways_request_envelope",
            required_geometry_meaning=geometry[source],
            transformer_method="identity_wgs84",
            pyproj_version=pyproj.__version__,
            proj_version=pyproj.proj_version_str,
        )
