...
- [docs/evaluation/RESEARCH_NEXT.md](docs/evaluation/RESEARCH_NEXT.md) — authoritative current research state, next gate, and prohibited next actions
...
- [SUPERVISOR_RESEARCH_DIRECTION.md](SUPERVISOR_RESEARCH_DIRECTION.md) — Sandra's direct scientific RSU load-management direction
